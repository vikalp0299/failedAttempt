...
public class DialogImplementExtentionActivity extends AppCompatActivity implements DialogsListAdapter.OnDialogClickListener<DialogModel>,DialogsListAdapter.OnDialogLongClickListener<DialogModel> {
